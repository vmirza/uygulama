(function( $ ){
    ...
    var m = {
        init: function(form){
            ...
            form.find('select:not(.forma), textarea:not(.forma), input[type=checkbox]:not(.forma), input[type=radio]:not(.forma)')
            .each(function(){        
                var i = $(this);
            ...
            // FILE
            form.find('input[type=file]:not(.droparea)')
            .each(function(){
