(function($){
    ...
    var methods = {
        ...
        set     : function(carousel){
            ...
            carousel.rail.width(carousel.width()-carousel.nav.width()*2);
            carousel.items.width(carousel.rail.width()*.25);
            carousel.step      = carousel.items.outerWidth(1);
            ...
            //console.log('set size: ', carousel.rail.width(), carousel.step);
        },
